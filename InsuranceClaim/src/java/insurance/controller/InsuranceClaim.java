 ...
 * @author Dell
 */
@WebServlet(name = "InsuranceClaim", urlPatterns = {"/InsuranceClaim"})
public class InsuranceClaim extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ArrayList<ClaimDetailsPojo> cdp=Insurance.getClaimByInsurance();
            if(!cdp.isEmpty())
             {
...
//                 System.out.println("Data not recieved");
        ...
        {
            System.out.println("ERROE IN INSURANCE CLAIMING");
