 ...
 * @author Dell
 */
@WebServlet(name = "UserRevertReq", urlPatterns = {"/UserRevertReq"})
public class UserRevertReq extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            if(user==null)
            {
             ...
             ArrayList<ClaimDetailsPojo> cdp=Hospital.getClaimDetailsByUserFault(user);
             if(!cdp.isEmpty())
             {
